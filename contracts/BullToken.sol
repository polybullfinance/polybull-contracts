...
contract BullToken is BEP20("PolyBull Token", "BULL") {
    // Burn address
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "BULL::transfer: Burn value invalid");
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BULLs (not scaled);
